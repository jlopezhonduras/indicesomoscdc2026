...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-06-2026 a las 21:25:08
...
(236, 135, 'Si', 'Si 135', 1),
(237, 137, 'Si', 'Si 137', 1),
(238, 141, '1', 'Muy malo', 1),
(239, 141, '2', 'Malo', 2),
(240, 141, '3', 'Regular', 3),
(241, 141, '4', 'Bueno', 4),
(242, 141, '5', 'Muy bueno', 5),
(243, 139, 'SI', 'Sí', 1),
(244, 139, 'NO', 'No', 2),
(245, 139, 'NS', 'No sabe', 3),
(246, 140, 'SI', 'Sí', 1),
(247, 140, 'NO', 'No', 2),
...
(139, 37, 'Durante los últimos 12 meses, ¿necesitó atención médica?', 'radio', 1, 999, 1, NULL),
(140, 37, '¿Pudo recibir la atención médica que necesitaba?', 'radio', 1, 1000, 1, NULL),
(141, 42, 'En general, ¿cómo evalúa su bienestar personal actualmente?', 'radio', 1, 1001, 1, NULL);
...
(11, 'admin@somoscdc.org', 'admin@somoscdc.org', 'Administrador', 'General', '$2a$12$KpWe.zPDK7UuxhJNfmLX/eY8AlKkt5yqXhN3aiSDaizcxBWEIg7RS', 5, '2026-06-24 08:49:41', 1, '2026-06-23 19:08:00', NULL, 1, '32949365', NULL),
...
--
ALTER TABLE `detalle_encuesta`
  MODIFY `id_detalle` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;

--
-- AUTO_INCREMENT de la tabla `encabezado_encuesta`
--
ALTER TABLE `encabezado_encuesta`
  MODIFY `id_encuesta` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `opciones_pregunta`
  MODIFY `id_opcion` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=249;
